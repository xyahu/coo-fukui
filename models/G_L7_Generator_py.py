...
class L7_UpwardDense_G(GAN_base):
    """ 3阶段生成器，向上密集连接。
    ...
    def __init__(self, img_ch=3, output_ch=3, t=2):
        super(L7_UpwardDense_G, self).__init__()
        ...
        """ 新版本为1 """
        self.atb1_1 = Attention_block(F_g= 32, F_l= 32, F_int=  1)
        ...
        self.up_rrb1_5 = RRCNN_block(ch_in= 512*3, ch_out=512, t=t)
        self.up_rrb1_4 = RRCNN_block(ch_in= 256*4, ch_out=256, t=t)
        self.up_rrb1_3 = RRCNN_block(ch_in= 128*5, ch_out=128, t=t)
        self.up_rrb1_2 = RRCNN_block(ch_in=  64*6, ch_out= 64, t=t)
        self.up_rrb1_1 = RRCNN_block(ch_in=  32*7, ch_out= 32, t=t)
        # self.up_rrb1_0 = RRCNN_block(ch_in=  32,   ch_out=  1, t=t)
        # self.up_rrb1_0 = RRCNN_block(ch_in=   1, ch_out=  1, t=t)
        
        # update:
        self.up_atb1_6_6t5 = UPAttention_block(F_g=512, F_l=512, F_int=256, x_c=1024, k=2)
        
        self.up_atb1_5_5t4 = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c= 512, k=2)
        self.up_atb1_5_6t4 = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c=1024, k=4)
        ...
        self.up_atb1_4_6t3 = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c=1024, k=8)
        ...
        self.up_atb1_3_6t2 = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c=1024, k=16)
        ...
        self.up_atb1_2_6t1 = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=1024, k=32)
        ...
        # up_rrb 系列通常在cat操作后，用于降低通道数。
        self.up_rrb2_5 = RRCNN_block(ch_in= 512*5, ch_out=512, t=t)
        self.up_rrb2_4 = RRCNN_block(ch_in= 256*7, ch_out=256, t=t)
        self.up_rrb2_3 = RRCNN_block(ch_in= 128*9, ch_out=128, t=t)
        self.up_rrb2_2 = RRCNN_block(ch_in=  64*11, ch_out= 64, t=t)
        self.up_rrb2_1 = RRCNN_block(ch_in=  32*13, ch_out= 32, t=t)
        # self.up_rrb2_0 = RRCNN_block(ch_in=  32, ch_out=  1, t=t)
        # self.up_rrb1_0 = RRCNN_block(ch_in=   1, ch_out=  1, t=t)
        
        self.up_atb2_6_6t5_1_x = UPAttention_block(F_g=512, F_l=512, F_int=256, x_c=1024, k=2)
        self.up_atb2_6_6t5_2_m = UPAttention_block(F_g=512, F_l=512, F_int=256, x_c=1024, k=2)
        
        self.up_atb2_5_5t4_1_x = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c= 512, k=2)
        self.up_atb2_5_6t4_1_x = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c=1024, k=4)
        self.up_atb2_5_5t4_2_m = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c= 512, k=2)
        self.up_atb2_5_6t4_2_m = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c=1024, k=4)
        
        self.up_atb2_4_4t3_1_x = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 256, k=2)
        self.up_atb2_4_5t3_1_x = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 512, k=4)
        self.up_atb2_4_6t3_1_x = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c=1024, k=8)
        self.up_atb2_4_4t3_2_m = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 256, k=2)
        self.up_atb2_4_5t3_2_m = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 512, k=4)
        self.up_atb2_4_6t3_2_m = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c=1024, k=8)
        
        self.up_atb2_3_3t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 128, k=2)
        self.up_atb2_3_4t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 256, k=4)
        self.up_atb2_3_5t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 512, k=8)
        self.up_atb2_3_6t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c=1024, k=16)
        self.up_atb2_3_3t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 128, k=2)
        self.up_atb2_3_4t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 256, k=4)
        self.up_atb2_3_5t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 512, k=8)
        self.up_atb2_3_6t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c=1024, k=16)
        
        self.up_atb2_2_2t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=  64, k=2)
        self.up_atb2_2_3t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 128, k=4)
        self.up_atb2_2_4t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 256, k=8)
        self.up_atb2_2_5t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 512, k=16)
        self.up_atb2_2_6t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=1024, k=32)
        self.up_atb2_2_2t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=  64, k=2)
        self.up_atb2_2_3t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 128, k=4)
        self.up_atb2_2_4t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 256, k=8)
        self.up_atb2_2_5t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 512, k=16)
        self.up_atb2_2_6t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=1024, k=32)
        ...
        # up_rrb 系列通常在cat操作后，用于降低通道数。
        self.up_rrb3_5 = RRCNN_block(ch_in= 7*512, ch_out=512, t=t)
        self.up_rrb3_4 = RRCNN_block(ch_in=10*256, ch_out=256, t=t)
        self.up_rrb3_3 = RRCNN_block(ch_in=13*128, ch_out=128, t=t)
        self.up_rrb3_2 = RRCNN_block(ch_in= 16*64, ch_out= 64, t=t)
        self.up_rrb3_1 = RRCNN_block(ch_in= 19*32, ch_out= 32, t=t)
        # self.up_rrb3_0 = RRCNN_block(ch_in=    32, ch_out=  1, t=t)
        
        self.up_atb3_6_6t5_1_x = UPAttention_block(F_g=512, F_l=512, F_int=256, x_c=1024, k=2) #  x用
        self.up_atb3_6_6t5_2_m = UPAttention_block(F_g=512, F_l=512, F_int=256, x_c=1024, k=2) # mx用
        self.up_atb3_6_6t5_3_n = UPAttention_block(F_g=512, F_l=512, F_int=256, x_c=1024, k=2) # nx用
        
        self.up_atb3_5_5t4_1_x = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c= 512, k=2) #  x用
        self.up_atb3_5_6t4_1_x = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c=1024, k=4) #  x用
        self.up_atb3_5_5t4_2_m = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c= 512, k=2) # mx用
        self.up_atb3_5_6t4_2_m = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c=1024, k=4) #  x用
        self.up_atb3_5_5t4_3_n = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c= 512, k=2) # nx用
        self.up_atb3_5_6t4_3_n = UPAttention_block(F_g=256, F_l=256, F_int=128, x_c=1024, k=4) #  x用
        
        self.up_atb3_4_4t3_1_x = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 256, k=2)
        self.up_atb3_4_5t3_1_x = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 512, k=4)
        self.up_atb3_4_6t3_1_x = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c=1024, k=8)
        self.up_atb3_4_4t3_2_m = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 256, k=2)
        self.up_atb3_4_5t3_2_m = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 512, k=4)
        self.up_atb3_4_6t3_2_m = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c=1024, k=8)
        self.up_atb3_4_4t3_3_n = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 256, k=2)
        self.up_atb3_4_5t3_3_n = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c= 512, k=4)
        self.up_atb3_4_6t3_3_n = UPAttention_block(F_g=128, F_l=128, F_int= 64, x_c=1024, k=8)
        
        self.up_atb3_3_3t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 128, k=2)
        self.up_atb3_3_4t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 256, k=4)
        self.up_atb3_3_5t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 512, k=8)
        self.up_atb3_3_6t2_1_x = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c=1024, k=16)
        
        self.up_atb3_3_3t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 128, k=2)
        self.up_atb3_3_4t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 256, k=4)
        self.up_atb3_3_5t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 512, k=8)
        self.up_atb3_3_6t2_2_m = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c=1024, k=16)
        
        self.up_atb3_3_3t2_3_n = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 128, k=2)
        self.up_atb3_3_4t2_3_n = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 256, k=4)
        self.up_atb3_3_5t2_3_n = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c= 512, k=8)
        self.up_atb3_3_6t2_3_n = UPAttention_block(F_g= 64, F_l= 64, F_int= 32, x_c=1024, k=16)
        
        self.up_atb3_2_2t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=  64, k=2)
        self.up_atb3_2_3t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 128, k=4)
        self.up_atb3_2_4t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 256, k=8)
        self.up_atb3_2_5t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 512, k=16)
        self.up_atb3_2_6t1_1_x = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=1024, k=32)
        
        self.up_atb3_2_2t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=  64, k=2)
        self.up_atb3_2_3t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 128, k=4)
        self.up_atb3_2_4t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 256, k=8)
        self.up_atb3_2_5t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 512, k=16)
        self.up_atb3_2_6t1_2_m = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=1024, k=32)
        
        self.up_atb3_2_2t1_3_n = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=  64, k=2)
        self.up_atb3_2_3t1_3_n = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 128, k=4)
        self.up_atb3_2_4t1_3_n = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 256, k=8)
        self.up_atb3_2_5t1_3_n = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c= 512, k=16)
        self.up_atb3_2_6t1_3_n = UPAttention_block(F_g= 32, F_l= 32, F_int= 16, x_c=1024, k=32)
    ...
    def forward(self, x):
        ...
        x1 = self.rrb1_1(road1) #    1 256 256 ->   32 256 256
        x2 = self.dwConv1_1(x1) #   32 256 256 ->   32 128 128
        x2 = self.rrb1_2(x2)    #   32 128 128 ->   64 128 128
