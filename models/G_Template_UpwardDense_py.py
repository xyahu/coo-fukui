...
class G_Template_UpwardDense(GAN_base):
    """ 3阶段生成器，向上密集连接。
    ...
    def __init__(self, img_ch=3, output_ch=3, t=2):
        super(G_Template_UpwardDense, self).__init__()
        ...
        self.up_atb1_2_2t1 = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=  C_l3, k=2)
        self.up_atb1_2_3t1 = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l4, k=4)
        self.up_atb1_2_4t1 = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l5, k=8)
        self.up_atb1_2_5t1 = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l6, k=16)
        self.up_atb1_2_6t1 = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=C_l7, k=32)
        ...
        self.atb2_1_1 = Attention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1)
        self.atb2_1_2 = Attention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1)
        ...
        self.atb3_1_1 = Attention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1)
        self.atb3_1_2 = Attention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1)
        self.atb3_1_3 = Attention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1)
        ...
        self.up_atb3_2_2t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=  C_l3, k=2)
        self.up_atb3_2_3t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l4, k=4)
        self.up_atb3_2_4t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l5, k=8)
        self.up_atb3_2_5t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l6, k=16)
        self.up_atb3_2_6t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=C_l7, k=32)
        
        self.up_atb3_2_2t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=  C_l3, k=2)
        self.up_atb3_2_3t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l4, k=4)
        self.up_atb3_2_4t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l5, k=8)
        self.up_atb3_2_5t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l6, k=16)
        self.up_atb3_2_6t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=C_l7, k=32)
        
        self.up_atb3_2_2t1_3_n = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=  C_l3, k=2)
        self.up_atb3_2_3t1_3_n = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l4, k=4)
        self.up_atb3_2_4t1_3_n = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l5, k=8)
        self.up_atb3_2_5t1_3_n = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c= C_l6, k=16)
        self.up_atb3_2_6t1_3_n = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= C_l1, x_c=C_l7, k=32)
