...
class L7_Template_UpwardDense_G(GAN_base):
    """ 3阶段生成器，向上密集连接。
    ...
    def __init__(self, img_ch=3, output_ch=3, t=2):
        super(L7_Template_UpwardDense_G, self).__init__()
        ...
        self.up_atb2_2_2t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c=  C_l3, k=2)
        self.up_atb2_2_3t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c= C_l4, k=4)
        self.up_atb2_2_4t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c= C_l5, k=8)
        self.up_atb2_2_5t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c= C_l6, k=16)
        self.up_atb2_2_6t1_1_x = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c=C_l7, k=32)
        self.up_atb2_2_2t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c=  C_l3, k=2)
        self.up_atb2_2_3t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c= C_l4, k=4)
        self.up_atb2_2_4t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c= C_l5, k=8)
        self.up_atb2_2_5t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c= C_l6, k=16)
        self.up_atb2_2_6t1_2_m = UPAttention_block(F_g= C_l2, F_l= C_l2, F_int= 16, x_c=C_l7, k=32)
